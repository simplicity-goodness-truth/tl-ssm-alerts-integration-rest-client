class zcl_logger_to_app_log definition
  public
  inheriting from zcl_logger_base
  final
  create private .
  ...
  private section.
    ...
    data:
      mv_message_type type symsgty,
      mv_object       type balobj_d,
      mv_subobject    type balsubobj.

    class-data mo_app_logger_instance type ref to zcl_logger_to_app_log .
...
class zcl_logger_to_app_log implementation.
  ...
  method add_record.
    ...
    " Check if object and subobject are provided
